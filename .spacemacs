...
values."
  (setq-default
   ...
   ;; Paths must have a trailing slash (i.e. `~/.emacs.d/contrib/')
   ;;dotspacemacs-configuration-layer-path '("~/.emacs.d/contrib/")
