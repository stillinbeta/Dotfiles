...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey            }, "Return",function ()
        for i, tag_config in ipairs(tag_settings) do
          ...
          if tags[scr][tag].selected and scr == mouse.screen.index then
            awful.spawn(tag_config[4])
          end
        end
      end,
      {description = "start the program associated with this tag", group = "awesome" }
    ),
...
for i, tag in ipairs(tag_settings)  do
    ...
    globalkeys = awful.util.table.join(globalkeys,
        awful.key({ modkey }, key,
                  ...
                  {description = "view tag #"..tag[1], group = "tag"}),
        awful.key({ modkey, "Control" }, key,
                  ...
                  {description = "toggle tag #" .. tag[1], group = "tag"}),
        awful.key({ modkey, "Shift" }, key,
                  ...
                  {description = "move focused client to tag #" .. tag[1], group = "tag"}),
        awful.key({ modkey, "Control", "Shift" }, key,
                  ...
                  {description = "toggle focused client on tag #" .. tag[1], group = "tag"})
        )
end
...
screen.connect_signal("list", function(s) awesome.restart() end)
